...
class CompanyProfilePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final stream = FirebaseFirestore.instance
        .collection('companies')        // ajuste o nome da coleção se for "users"
        ...
        return SingleChildScrollView(
          ...
          child: Column(
            ...
            children: [
              ...
              ProfileField(title: 'Nome da Empresa', subtitle: nomeEmpresa, icon: Icons.business),
              ...
              const ProfileField(title: 'Histórico de Serviços', icon: Icons.history),
