    ...
    return Scaffold(
      ...
      body: SafeArea(
        ...
        child: StreamBuilder<QuerySnapshot<Map<String, dynamic>>>(
          ...
          if (docs.isEmpty) {
            return const Center(child: Text('Você ainda não fez solicitações'));
          }
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, i) {
              ...
              final characterName = (x['characterName'] as String?) ?? 'Personagem';
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              ...
                              Text(
                                address.isNotEmpty ? address : 'Local não informado',
                                style: const TextStyle(
                                  color: Colors.grey,
                                  fontSize: 14,
                                ),
